...
namespace Org.BouncyCastle.Crypto.Engines
{
        ...
        : IAsymmetricBlockCipher
    {
            ...
            int inLen)
        {
            ...
            if (key is ExternalRsaKeyParameters)
            {
                if (forEncryption)
                    return ((ExternalRsaKeyParameters)key).PrivateSign(inBuf, inOff, inLen);
                else
                    return ((ExternalRsaKeyParameters)key).PrivateDecrypt(inBuf, inOff, inLen);
            }
